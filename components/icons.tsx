...
export const WandIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="m21.64 3.64-1.28-1.28a1.21 1.21 0 0 0-1.71 0L11.5 9.51l-7 7L3.21 15.21a1.21 1.21 0 0 0 0 1.71l1.28 1.28a1.21 1.21 0 0 0 1.71 0l7.12-7.12 7.12-7.12a1.21 1.21 0 0 0 0-1.71z" />
        <path d="m11.5 9.51 7.12-7.12" />
        <path d="M5.5 12.5 4 14" />
        <path d="M12.5 5.5 14 4" />
